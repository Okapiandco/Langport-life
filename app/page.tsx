...
export default async function HomePage() {
  ...
  return (
    <>
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {navCards.map((card) => (
              <Link
                key={card.title}
                href={card.href}
                className={`group relative block overflow-hidden rounded-lg border-4 ${card.borderColor} no-underline shadow-sm hover:shadow-lg transition-shadow`}
              >
                <div className="relative aspect-[4/3] w-full overflow-hidden">
                  ...
                  <h3 className="absolute bottom-4 left-5 right-5 font-heading text-2xl font-bold text-white drop-shadow-lg sm:text-3xl">
                    {card.title}
                  </h3>
                </div>
                <div className={`h-2 ${card.barColor}`} />
              </Link>
            ))}
          </div>
        </div>
      ...
      {/* Community Stats — inspired by Visit Cambridge's "Why you should list" */}
      <section className="relative overflow-hidden bg-copper text-white">
        {/* Decorative circles */}
        <svg
          className="absolute -right-16 top-1/2 -translate-y-1/2 h-72 w-72 text-white/10"
          viewBox="0 0 200 200"
          aria-hidden="true"
        >
        ...
        <svg
          className="absolute -right-8 top-1/2 -translate-y-1/2 h-48 w-48 text-white/5"
          viewBox="0 0 200 200"
          aria-hidden="true"
        >
          <circle cx="100" cy="100" r="100" fill="currentColor" />
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg text-white/90 leading-relaxed">
                Langport Life is the community hub for our historic Somerset
                town. We help local businesses, venues, and event organisers
                connect with residents and visitors alike.
              </p>
              <Link
      ...
      {/* Featured Articles — inspired by Visit Cambridge's editorial overlay cards */}
      {data.latestArticles?.length > 0 && (
        <section className="relative overflow-hidden">
          {/* Decorative background circle */}
          <svg
            className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/3 h-[500px] w-[500px] text-light-blue/20"
            viewBox="0 0 200 200"
            aria-hidden="true"
          >
            <circle cx="100" cy="100" r="100" fill="currentColor" />
            ...
            <div className="flex items-end justify-between">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  News and stories from the Langport community.
                </p>
              </div>
              <Link
                href="/news"
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {data.latestArticles.map((article: any, i: number) => (
                <Link
                  ...
                  className={`group relative block overflow-hidden rounded-xl no-underline shadow-md transition-shadow hover:shadow-xl ${
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
                      ...
                      <h3
                        className={`mt-2 font-heading font-bold text-white drop-shadow ${
      ...
      {/* Did You Know — inspired by Visit Cambridge */}
      <section className="border-t border-b border-gray-200 bg-white">
        <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-2 text-gray-600 leading-relaxed">
            Langport was once one of the most important towns in Somerset,
            serving as a major inland port and mint town in Saxon times. The
            Hanging Chapel on the hill is one of only a handful of such
            structures remaining in England.
          </p>
        </div>
      </section>
      ...
      <section className="bg-primary text-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-white/90">
            Submit your event and reach the Langport community. It&apos;s free
            and easy to get listed.
          </p>
          <Link
            href="/dashboard/my-events/new"
