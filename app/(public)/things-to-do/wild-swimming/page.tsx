...
export default function WildSwimmingPage() {
  return (
    <>
      <PageHero title="Wild Swimming" subtitle="Take to the water on warm summer days" section="things-to-do" breadcrumbs={[{ label: "Things to Do", href: "/things-to-do" }, { label: "The Outdoor Life", href: "/things-to-do/outdoor-life" }, { label: "Wild Swimming" }]} image="/things-to-do/wild-swimming-hero.jpg" />
