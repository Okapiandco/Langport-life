...
export default function PaddleboardingPage() {
  return (
    <>
      <PageHero title="Paddleboarding" subtitle="Our beautiful river is more active than it's been in over a century!" section="things-to-do" image="/things-to-do/paddleboarding.jpg" />
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <nav className="mb-6 text-sm text-gray-500">
          ...
          <span className="text-gray-900">Paddleboarding</span>
        </nav>
