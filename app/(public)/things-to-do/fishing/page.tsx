...
export default function FishingPage() {
  return (
    <>
      <PageHero title="Fishing" subtitle="River Parrett and local lakes" section="things-to-do" breadcrumbs={[{ label: "Things to Do", href: "/things-to-do" }, { label: "The Outdoor Life", href: "/things-to-do/outdoor-life" }, { label: "Fishing" }]} image="/things-to-do/wild-swimming.jpg" />
