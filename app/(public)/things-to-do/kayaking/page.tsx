...
export default function KayakingPage() {
  return (
    <>
      <PageHero title="Kayaking & Canoeing" subtitle="Launch your own craft or hire canoes and kayaks on the River Parrett" section="things-to-do" image="/things-to-do/kayaking.jpg" />
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <nav className="mb-6 text-sm text-gray-500">
          ...
          <span className="text-gray-900">Kayaking & Canoeing</span>
        </nav>
